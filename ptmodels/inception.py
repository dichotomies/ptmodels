...
__all__ = ['Inception2', 'inception_v3']

model_urls = {
    # Inception v2 ported from Caffee to pytorch, then ported to PT 0.4
    # pt 0.3 port: URL = 'http://data.lip6.fr/cadene/pretrainedmodels
    #     /bn_inception-239d2248.pth'
    'inception_v2': '/export/home/vtschern/data/model-zoo/bn-pt-0.4.pt',
}
